...
public class Program {
    public static void main(String[] args) {
        ...
        System.out.println("a.normEuclidean(): " + a.normEuclidean());
        System.out.println("b.normEuclidean(): " + b.normEuclidean());
        System.out.println("a.mul(b): " + a.mul(b));
        System.out.println("b.mul(a): " + b.mul(a)); System.out.print("Вектор a после сортировки: ");
        a.sort();
        a.print();
        System.out.print("Вектор b после сортировки: "); b.sort();
        b.print(); System.out.print("a.mul(2.5): ");
        a.mul(2.5).print();
        System.out.print("a.sum(b): ");
        a.sum(b).print();
        System.out.print("b.sum(a): ");
        b.sum(a).print();
